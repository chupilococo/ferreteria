	  ...
	  <form action="modulos/stock/update.php" method='POST' class="form">
		<div class="modal-body">
			...
			<label for="proveedor">Proveedor</label>
				<select class='form-control' name='proveedor' value='<?php echo $row['proveedor'];?>' type="text" value=''>
			...
			<label for="codigo">Precio</label><input class='form-control' value='<?php echo $row['precio'];?>' name='precio' type="number" />
